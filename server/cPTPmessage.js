...
module.exports = {
    ...
    init: function (msgType, sender, peerTable, searchId, imagePort = 0, imageIP = 0, imageName = '') {
        ...
        if (msgType == 1 || msgType == 2) {
            ...
            let imageNameBytes = stringToBytes(imageName);

            this.message = new Buffer.alloc(20 + imageNameBytes.length);
            ...
            //image name
            for (var Ni = 0; Ni < imageNameBytes.length; Ni++)
            this.message[Ni + 20] = imageNameBytes[Ni];
        }
    },
